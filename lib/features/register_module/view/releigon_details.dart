...
class ReligionDetailsScreen extends StatefulWidget {
  @override
  _ReligionDetailsScreenState createState() => _ReligionDetailsScreenState();
}
...
class _ReligionDetailsScreenState extends State<ReligionDetailsScreen> {
  ...
  Future<void> initializeData() async {
    ...
    try {
      ...
      if (isRegistered) {
        final savedReligion = prefs.getString('religion')?.trim().toLowerCase();
        final savedCaste = prefs.getString('caste')?.trim().toLowerCase();

        if (savedReligion != null && savedReligion.isNotEmpty) {
          ...
          if (savedCaste != null && savedCaste.isNotEmpty) {
