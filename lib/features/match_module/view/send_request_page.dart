...
class SendMatchesPage extends StatefulWidget {
  const SendMatchesPage({super.key});
...
class _SendMatchesPageState extends State<SendMatchesPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      matchProvider.fetchSentInterests();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final sentRequests = matchProvider.sentRequestList;
              ...
              : sentRequests.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final imagePath =
                            "https://matrimony.sqcreation.site/${match.receiver.profile}";
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text('Age: ${match.receiver.age}',
                                        style:
                                            TextStyle(color: Colors.grey[700])),
                                    if (match.receiver.city?.name != null)
                                      Text('City: ${match.receiver.city!.name}',
                                          style: TextStyle(
                              ...
                              OutlinedButton(
                                ...
                                onPressed: () async {
                                  final response = await matchProvider
                                      .revokeInterestRequest(match.interestId);
